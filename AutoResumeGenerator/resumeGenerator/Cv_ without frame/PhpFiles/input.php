...
<br>
        <div class="main-section-input">
            <form method="POST" name="resumeData" action="resume.php">
                <table style="margin-left: 140px; width: 80%;">
                    ...
                    <tr>
                        <td> Sub-Heading </td>
                        <td> <input style="float: right; margin-right:50px;" type="text" name="sub_heading" required> </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Linked link</td>
                        <td><input style="float: right;" type="text" name="linked"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <input class="submit-button" type="submit" name="submit" ><br>
                <br>
                        </td>
                    </tr>
                </table>
